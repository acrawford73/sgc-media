...
# Models
from .models import PlaylistVideo, PlatlistVideoItems
from .models import PlaylistAudio, PlaylistAudioItems
from .models import PlaylistPhoto, PlaylistPhotoItems
